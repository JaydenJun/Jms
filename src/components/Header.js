      ...
      <header className="header container">
        ...
        <div className="h_con">
          <ul className="clearfloat">
            ...
            <li><a href="javascript:void(0)" className="weixin"></a></li>
            <li><a href="javascript:void(0)" className="weibo"></a></li>
            {
              userName
                ?
                (<>
                  <li className="top_user"><Link to="/usercenter">{userName}</Link></li>
                  <li className="top_quit"><a href="javascript:void(0)" onClick={logout}>退出</a></li>
                </>)
                :
                (<>
        ...
        <div className="container">
          ...
          <div className="s_cart" onMouseEnter={() => setShowDropdown(true)} onMouseLeave={() => setShowDropdown(false)}>
            ...
            <div className="cart_dropdown" style={{ display: showDropdown ? 'block' : 'none' }}>
              ...
              <ul>
                {/*<li>*/}
                {/*<a href="javascript:void(0)"><img src="product-imgs/jhq-m8088a.jpg" alt=""/></a>*/}
                {/*<div>*/}
